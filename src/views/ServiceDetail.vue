<template>
  <div v-if="service">
    <router-link to="/" class="text-orange-500 hover:underline text-sm mb-4 inline-block">← Back</router-link>
...
const service = computed(() => data.services.find(s => s.id === props.id))
</script>
